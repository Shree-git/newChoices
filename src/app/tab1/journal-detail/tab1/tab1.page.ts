...
export class Tab1Page implements OnInit{
 ...
 private alertCtrl: AlertController,
  ...
  ngOnInit(){
    this.journals = this.journalService.getAllJournals(this.userId)
  ...
  dismissPopover() {
    if (this.currentPopover) {
      this.currentPopover.dismiss().then(() => { this.currentPopover = null; this.journals = this.journalService.getAllJournals(this.userId); });
    }
  }
