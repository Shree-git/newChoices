...
export class JournalService {
  ...
  getAllJournals(userId): Observable<Journal[]>{

    // console.log(this.aService.getUser().email)
    this.userId = userId;
    this.journalsCollection = this.afStore.collection('users').doc(userId).collection('journals')
  ...
  searchJournals(searchWord){
    ...
    return this.afStore.collection('users').doc(this.userId).collection('journals' , ref => 
