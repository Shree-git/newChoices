...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function srcAppExploreContainerExploreContainerComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppSettingsAccountAccountServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AccountService = /*#__PURE__*/function () {
      function AccountService(authService, afStore, location) {
        var _this = this;
        ...
        if (this.authService.isLoggedIn) {
          this.afStore.collection('accounts').doc(this.authService.user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (account) {
            account.id = _this.authService.user.uid;
            return account;
      ...
      _createClass(AccountService, [{
        ...
        value: function createAccount(account) {
          ...
          this.afStore.collection('accounts').doc(this.authService.user.uid).set({
            fName: account.fName,
            lName: account.lName,
            role: 'client',
            darkTheme: false,
            ...
            _this2.account = {
              id: _this2.authService.user.uid,
              fName: account.fName,
              lName: account.lName,
              role: 'client',
              darkTheme: false,
        ...
        value: function updateAccount(account) {
          ...
          this.afStore.collection('accounts').doc(this.authService.user.uid).update({
            fName: account.fName,
            lName: account.lName,
            mobileNumber: account.mobileNumber
          }).then(function () {
            _this3.account = {
              id: _this3.authService.user.uid,
              fName: account.fName,
              lName: account.lName,
              role: _this3.account.role,
              darkTheme: _this3.account.darkTheme,
              therapists: _this3.account.therapists,
              mobileNumber: _this3.account.mobileNumber
            }; // this.location.back()
          });
        }
      }, {
        ...
        value: function updateTheme(theme) {
          ...
          this.afStore.collection('accounts').doc(this.authService.user.uid).update({
            ...
            _this4.account = {
              id: _this4.authService.user.uid,
              fName: _this4.account.fName,
              lName: _this4.account.lName,
              role: _this4.account.role,
              darkTheme: theme,
              therapists: _this4.account.therapists,
              mobileNumber: _this4.account.mobileNumber
            }; // this.location.back()
          });
        }
      }, {
        ...
        value: function getAccount() {
          ...
          //   }));
          this.afStore.collection('accounts').doc(this.authService.user.uid).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (account) {
            account.id = _this5.authService.user.uid;
            return account;
          })).subscribe(function (account) {
