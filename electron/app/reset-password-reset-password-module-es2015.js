...
let ResetPasswordPage = class ResetPasswordPage {
    constructor(formBuilder, authService, alertCtrl, router) {
    ...
    reset() {
        return this.authService.passwordReset(this.registerForm.get('email').value).then(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
