...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
  ...
  function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(formBuilder, authService, router, platform) {
        ...
        this.registerForm = this.formBuilder.group({
          ...
          password: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_5__["Validators"].required])]
        });
      }
      ...
      _createClass(LoginPage, [{
        ...
        value: function login() {
          ...
          this.authService.login(this.registerForm.get('email').value, this.registerForm.get('password').value).then(function () {
            _this.router.navigate(['/tabs']);
          })["catch"](function (err) {
            _this.loginError = true;
            _this.loginErrorMessage = err.message;
          });
        }
      }, {
        key: "ionViewDidEnter",
        value: function ionViewDidEnter() {
          ...
          this.backButtonSubscription = this.platform.backButton.subscribe(function () {
            if (_this2.router.isActive('/login', true) && _this2.router.url === '/login') {
