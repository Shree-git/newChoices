...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppSettingsAccountAccountPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSettingsAccountAccountRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        /*! import() | display-photo-display-photo-module */
        "display-photo-display-photo-module").then(__webpack_require__.bind(null,
        /*! ./display-photo/display-photo.module */
        "./src/app/settings/account/display-photo/display-photo.module.ts")).then(function (m) {
          return m.DisplayPhotoPageModule;
        });
      }
    }, {
      path: 'password-reset',
      loadChildren: function loadChildren() {
        ...
        "./src/app/settings/account/password-reset/password-reset.module.ts")).then(function (m) {
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | change-email-change-email-module */
        "change-email-change-email-module").then(__webpack_require__.bind(null,
        /*! ./change-email/change-email.module */
        "./src/app/settings/account/change-email/change-email.module.ts")).then(function (m) {
  ...
  /***/
  function srcAppSettingsAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSettingsAccountAccountPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppSettingsAccountAccountPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AccountPage = /*#__PURE__*/function () {
      function AccountPage(accountService, location, authService) {
    ...
    AccountPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/settings/account/account.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./account.page.scss */
      "./src/app/settings/account/account.page.scss"))["default"]]
    })], AccountPage);
    /***/
  }
}]);
